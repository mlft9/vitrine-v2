...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-900 mt-auto" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        >
          <motion.div className="space-y-8" variants={itemVariants}>
            ...
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400 max-w-md">
              Premium game server hosting with unmatched performance, reliability, and 24/7 support. Power your gaming community with confidence.
            </p>
        ...
        >
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} GameHost. All rights reserved. Powered by cutting-edge technology and a passion for gaming.
          </p>
        </motion.div>
      </div>
    </footer>
