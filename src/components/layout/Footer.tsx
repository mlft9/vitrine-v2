...
const navigation = {
  solutions: [
    { name: 'Espace Cloud', href: 'https://client.frozenhost.fr/store/vps-cloud' },
    { name: 'Offres Game', href: 'https://client.frozenhost.fr/store/vps-game' },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        >
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} aCollective. Tous droits réservés. 
          </p>
        </motion.div>
      </div>
    </footer>
